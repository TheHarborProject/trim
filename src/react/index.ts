...
export type { TrimConfig, TrimGroupDef, TrimGroupItem, TrimLayoutProps, TrimResolvedGroup, TrimResolvedGroupItem, TrimRenderer, TrimRendererMap, TrimUIAdapter, TrimShell, TrimShellProps } from "./config";
